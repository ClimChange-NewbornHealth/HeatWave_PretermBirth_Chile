...
writexl::write_xlsx(results_cox, path =  paste0("Output/", "Models/", "Cox_models_lm_full", ".xlsx"))
...
ggsave(plots$birth_preterm + labs(title = "A. Preterm (<37 weeks)"),
     filename = paste0("Output/", "Models/", "PTB_COX_lm_full", ".png"), # "Preterm_trendsrm1991"
     res = 300,
     width = 20,
     height = 15,
     units = 'cm',
