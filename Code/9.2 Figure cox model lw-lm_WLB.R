...
results_cox_lw <- rio::import(paste0("Output/", "Models/", "Cox_models_lw_wlb", ".xlsx"))
results_cox_lm <- rio::import(paste0("Output/", "Models/", "Cox_models_lm_wlb", ".xlsx"))
...
ggsave(plots_save,
  filename = paste0("Output/", "Models/", "PTB_COX_LM_LW_wlb", ".png"), 
  res = 300,
  width = 28,
  height = 23,
  units = 'cm',
