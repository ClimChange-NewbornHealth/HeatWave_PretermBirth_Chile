...
writexl::write_xlsx(results_cox, path =  paste0("Output/", "Models/", "Cox_models_lw_wlb", ".xlsx"))

results_cox <- rio::import(paste0("Output/", "Models/", "Cox_models_lw_wlb", ".xlsx"))
...
ggsave(plots$birth_preterm + labs(title = "A. Preterm (<37 weeks)"),
       filename = paste0("Output/", "Models/", "PTB_COX_wlb", ".png"), # "Preterm_trendsrm1991"
       res = 300,
       width = 20,
       height = 15,
       units = 'cm',
...
ggsave(plots$birth_late_preterm + labs(title = "B. Late Preterm (34-37 weeks)"),
       filename = paste0("Output/", "Models/", "PTB_late_COX_wlb", ".png"), # "Preterm_trendsrm1991"
       res = 300,
       width = 15,
       height = 15,
       units = 'cm',
...
ggsave(plots$birth_moderately_preterm + labs(title = "C. Moderately Preterm (32-33 weeks)"),
  filename = paste0("Output/", "Models/", "PTB_moderate_COX_wlb", ".png"), # "Preterm_trendsrm1991"
  res = 300,
  width = 20,
  height = 15,
  units = 'cm',
...
ggsave(plots$birth_very_preterm + labs(title = "D. Very Preterm (28-32 weeks)"),
  filename = paste0("Output/", "Models/", "PTB_very_COX_wlb", ".png"), # "Preterm_trendsrm1991"
  res = 300,
  width = 20,
  height = 15,
  units = 'cm',
...
ggsave(plots_save,
  filename = paste0("Output/", "Models/", "PTB_COX_SUP_wlb", ".png"), 
  res = 300,
  width = 30,
  height = 35,
  units = 'cm',
...
writexl::write_xlsx(table_models, path =  paste0("Output/", "Models/", "Table_COX_lw_wlb", ".xlsx"))
