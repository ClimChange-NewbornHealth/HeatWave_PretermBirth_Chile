# Code 6.1: Survival models Last Month ----
...
fit_cox_model(dep_var, hw_var, data=bw_data_lm)
})
toc() # time: 1729.685 sec elapsed, 28 min
...
writexl::write_xlsx(results_cox, path =  paste0("Output/", "Models/", "Cox_models_lm_wlb", ".xlsx"))

#results_cox <- rio::import(paste0("Output/", "Models/", "Cox_models_lm_wlb", ".xlsx"))
...
ggsave(plots_save,
filename = paste0("Output/", "Models/", "PTB_COX_SUP_LM_wlb", ".png"), 
res = 300,
width = 30,
height = 25,
units = 'cm',
...
ggsave(plots$birth_preterm + labs(title = "A. Preterm (<37 weeks)"),
     filename = paste0("Output/", "Models/", "PTB_COX_lm_wlb", ".png"), # "Preterm_trendsrm1991"
     res = 300,
     width = 20,
     height = 15,
     units = 'cm',
...
filename = paste0("Output/", "Models/", "PTB_very_COX_lm_wlb", ".png"), # "Preterm_trendsrm1991"
res = 300,
width = 20,
height = 15,
units = 'cm',
...
filename = paste0("Output/", "Models/", "PTB_moderate_COX_lm_wlb", ".png"), # "Preterm_trendsrm1991"
res = 300,
width = 20,
height = 15,
units = 'cm',
...
ggsave(plots$birth_late_preterm + labs(title = "D. Late Preterm (34-37 weeks)"),
     filename = paste0("Output/", "Models/", "PTB_late_COX_lm_wlb", ".png"), # "Preterm_trendsrm1991"
     res = 300,
     width = 15,
     height = 15,
     units = 'cm',
...
writexl::write_xlsx(table_models, path =  paste0("Output/", "Models/", "Table_COX_lm_wlb", ".xlsx"))
